...
echo Starting Real Estate Scraper Pipeline (Phases 1-5, 8, 9)
echo ========================================================
echo.
...
python phase3_scrape.py --workers 25 --delay 0.0
if %errorlevel% neq 0 (
...
echo.
echo --- Phase 9: Final Formatting and Data Cleaning ---
python phase9_process.py
if %errorlevel% neq 0 (
    echo [ERROR] Phase 9 failed!
    pause
    exit /b %errorlevel%
)
...
echo Final results are in the output/ directory (Phase9_*.csv).
echo ========================================================
echo.
